...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Ventas al Mayor</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
        <li class="breadcrumb-item active">Ventas al Mayor</li>
    </ol>

    @can('crear-ventaMayor')
    <div class="mb-4">
        <a href="{{route('ventasMayor.create')}}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                @can('mostrar-ventaMayor')
                                
                                <form action="{{route('ventasMayor.show', $item) }}" method="get">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ route('ventasMayor.destroy', $item) }}" method="post">
                                        @method('DELETE')
                                        @csrf
