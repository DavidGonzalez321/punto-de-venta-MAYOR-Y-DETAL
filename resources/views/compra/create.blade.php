                ...
                <div class="p-3 border border-3 border-primary">
                    <div class="row">
                        ...
                        <div class="col-sm-4 mb-2">
                            ...
                            <input type="number" name="precio_ventaMayor" id="precio_ventaMayor" class="form-control" step="0.1">
                        </div>
...
<script>
    ...
    function agregarProducto() {
        ...
        if (nameProducto != '' && nameProducto != undefined && cantidad != '' && precioCompra != '' && precioVenta != '' && precioVentaMayor != '') {

            //2. Para que los valores ingresados sean los correctos
            if (parseInt(cantidad) > 0 && (cantidad % 1 == 0) && parseFloat(precioCompra) > 0 && parseFloat(precioVenta) > 0 && parseFloat(precioVentaMayor) > 0) {

                //3. Para que el precio de compra sea menor que el precio de venta
                if (parseFloat(precioVenta) && parseFloat(precioVentaMayor) > parseFloat(precioCompra)) {
                    //Calcular valores
