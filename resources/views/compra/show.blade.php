            ...
            <table class="table table-striped">
                <thead class="bg-primary">
                    <tr class="align-top">
                        ...
                        <th class="text-white">Ganancias por venta</th>
                        <th class="text-white">Ganancias por venta al mayor</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-subtotal">
                            {{($item->pivot->precio_venta) - ($item->pivot->precio_compra)  }}
                        </td>
                        <td class="td-subtotal">
                            {{($item->pivot->precio_ventaMayor) - ($item->pivot->precio_compra) }}
                        </td>
                    </tr>
                    @endforeach
                </tbody>
