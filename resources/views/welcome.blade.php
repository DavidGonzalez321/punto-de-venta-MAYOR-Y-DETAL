...
<body>
    ...
    <div id="carouselExample" class="carousel slide carousel-fade">
      <center>
      <img src="{{asset('assets/img/welcome.png')}}" class="d-block h-60 " style="height: 500px; width:80%; margin:15px; border-radius:25px;" alt="banner de invitacion">
    ...
    <footer class="text-center text-white">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2024 Copyright:
            <a class="text-white" href="https://instagram.com/cyberwolfv/">cyberwolf</a>
        </div>
        <!-- Copyright -->
    </footer>
